...
public class PrivacyPolicyCleanerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_privacy_policy_cleaner, container, false);
        ...
        TextView tv =v.findViewById(R.id.privacypolicytext);
        tv.setText(str);
        return v;
    }
}